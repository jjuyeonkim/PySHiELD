...
class PhysicsConfig:
    ...
    # TODO: Make this a from_namelist and create a separate
    # from_f90nml that creates an ndsl.Namelist and calls
    # from_namelist.
    @classmethod
    def from_f90nml(cls, namelist: Namelist) -> "PhysicsConfig":
        """ TODO """

        # TODO Double-check for any additional target groups
        # TODO Make target_groups constant above?
        namelist = Namelist(namelist)
        target_groups = ["main_nml", "coupler_nml", "gfdl_cloud_microphysics_nml", "integ_phys_nml"]
